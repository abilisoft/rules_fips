...
[`v0.3.9`](https://github.com/abilisoft/rules_fips/tree/v0.3.9) is the current
...
git_override(
    ...
    commit = "<full peeled commit ID for v0.3.9>",
)
```
...
```console
git fetch https://github.com/abilisoft/rules_fips.git tag v0.3.9
...
```console
git tag -s v0.3.9 -m "rules_fips v0.3.9"
